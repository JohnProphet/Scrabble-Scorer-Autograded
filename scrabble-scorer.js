...
function scrabbleScorer() { transform(oldScrabbleScorer);
}
...
//   console.log(`The score for ${catchTheWord} is ` + simpleScore + '.');
   ...
   } else if (scorerChoice = 2) { (oldScrabbleScorer(catchTheWord));
   } else { 
...
//simpleScorer(catchTheWord);
//vowelBonusScorer(catchTheWord);
//console.log(catchTheWord);
}
